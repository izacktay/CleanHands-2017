...
class DataController {
  ...
  func savedRemark() {
    NSKeyedArchiver.archiveRootObject(outRemark, toFile: RecordsTVC.aURLremark.path)
  }
  
  
  func loadRemark() -> String?  {
    let succ = NSKeyedUnarchiver.unarchiveObject(withFile: RecordsTVC.aURLremark.path) as? String
